    ...
    return (<>
        <div className="box">
            <div className="settings">
                ...
                <NumInput id="delay" minVal={100} maxVal={1000} defaultVal={200} text="Move Delay (ms)" parentCallback={parentCallbacks[1]} isDisabled={isDisabled}/>
            ...
            <Button text="Solve" id="solve-button" isDisabled={buttonDisabled} clickFunction={clickHandler}/>
        </div></>)
}